...
# Remove queries any algorithms can't find embeddings in time.
...
# For incy, num_attributes = [1.0, 0.95, 0.9, 0.85, 0.8, 0.75, 0.7]
num_attributes = 1
...
# Reduction ratio. 
# When you try training size = 10, 
# train_rate = 10, test_size -> train_size.
train_rate = 1/2

X_train_subset_cs, _, y_train_subset_cs, _ = train_test_split(
X_train_cs, y_train_cs, test_size=train_rate, random_state=1, shuffle=True
)
X_train_idx_cs = X_train_subset_cs
X_train_subset_db, _, y_train_subset_db, _ = train_test_split(
X_train_db, y_train_db, test_size=train_rate, random_state=1, shuffle=True
)
X_train_idx_db = X_train_subset_db
X_train_subset_hm, _, y_train_subset_hm, _ = train_test_split(
X_train_hm, y_train_hm, test_size=train_rate, random_state=1, shuffle=True
)
X_train_idx_hm = X_train_subset_hm
X_train_subset_tw, _, y_train_subset_tw, _ = train_test_split(
X_train_tw, y_train_tw, test_size=train_rate, random_state=1, shuffle=True
)
X_train_idx_tw = X_train_subset_tw
X_train_subset_wn, _, y_train_subset_wn, _ = train_test_split(
X_train_wn, y_train_wn, test_size=train_rate, random_state=1, shuffle=True
)
X_train_idx_wn = X_train_subset_wn
X_train_subset_ys, _, y_train_subset_ys, _ = train_test_split(
X_train_ys, y_train_ys, test_size=train_rate, random_state=1, shuffle=True
)
X_train_idx_ys = X_train_subset_ys
X_train_subset_yt, _, y_train_subset_yt, _ = train_test_split(
X_train_yt, y_train_yt, test_size=train_rate, random_state=1, shuffle=True
)
X_train_idx_yt = X_train_subset_yt

X_train_cs = X_train_subset_cs
y_train_cs = y_train_subset_cs
X_train_db = X_train_subset_db
y_train_db = y_train_subset_db
X_train_hm = X_train_subset_hm
y_train_hm = y_train_subset_hm
X_train_tw = X_train_subset_tw
y_train_tw = y_train_subset_tw
X_train_wn = X_train_subset_wn
y_train_wn = y_train_subset_wn
X_train_ys = X_train_subset_ys
y_train_ys = y_train_subset_ys
X_train_yt = X_train_subset_yt
y_train_yt = y_train_subset_yt
