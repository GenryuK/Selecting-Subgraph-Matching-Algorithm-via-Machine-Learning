...
X = data[['data', 'file_name', 'feature1', 'feature2', 'feature3', 'feature4', 'feature5', 'feature7', 'feature9', 'feature10', 'feature8', 'feature6', 'feature13']]
...
seed_num = 1
test_mask = X["file_name"].str.startswith("query_64")
X_test = X[test_mask]
...
test_results.to_csv(f'query_64_{seed_num}.csv', index=False, encoding='utf-8')
...
train_source.to_csv(f'training_query_64_{seed_num}.csv', index=False, encoding='utf-8')